...
const RANDOM_TRAITS = {
  ...
  hairStyles: [
    ...
    "afro hair", "coily natural hair", "cornrows", "locs", "twists",
    "box braids", "a puff of curls tied up", "a wash-and-go curl",
    "a buzzed undercut", "a man bun", "a top knot", "a crew cut", "a slicked-back style",
    "a side-swept fringe", "blunt bangs", "curtain bangs", "a shag cut",
    "a centre-parted lob", "a receding hairline", "hair thinning on top",
    "a comb-over", "a low bun", "a neat side part",
    "hair scraped into a tight ponytail", "bedhead, just woken up",
  ],
  hairColors: [
    ...
    "jet black", "chestnut brown", "ash blonde", "platinum blonde",
    "strawberry blonde", "copper", "chocolate brown", "mostly grey",
    "white", "greying at the temples", "highlighted with balayage",
    "henna red", "black with a few greys coming through",
  ],
  expressions: [
  ...
  locations: [
    ...
    "on a São Paulo street, dense apartment blocks behind",
    "in a Buenos Aires café, tiled floor and old woodwork behind",
...
function generateRandomPrompt(opts: PromptOptions = {}): string {
  ...
  // Build / face-shape variety (~45% of images, all modes) so subjects aren't
  // all slim and symmetrical, which reads as AI.
  ...
  const noBorderSuffix =
    ". Full-bleed photograph, no Polaroid frame, no white border around the image, no decorative edges. Any people in the background stay soft and out of focus, never sharply detailed";
    ...
    <>
      ...
      <div className="grid gap-6 lg:grid-cols-[1fr_320px]">
        ...
        <div className="space-y-6">
          ...
          {/* First-run sample pack: before anyone has generated (and once
              localStorage has been read, so restored galleries don't flash
              this), offer a ready-made pack so visitors can see real output
              and try it as a profile picture without an API key or credits. */}
          {hydrated && !isGenerating && images.length === 0 && (
            <Card>
              <CardContent className="flex flex-col items-start gap-4 sm:flex-row sm:items-center sm:justify-between">
                <div className="space-y-1">
                  ...
                  <p className="max-w-prose text-sm text-muted-foreground">
                    Download a pack of 100 ready-made sample faces (~9&nbsp;MB) to
                    try as profile pictures — no API key or generation needed.
                  </p>
                </div>
                <Button
                  size="lg"
